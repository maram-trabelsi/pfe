...
class Chambre1 extends StatefulWidget {
  const Chambre1({super.key});

  @override
  State<Chambre1> createState() => _Chambre1State();
}

class _Chambre1State extends State<Chambre1> {
  int? _selectedIndex ;
  @override
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                         ...
                         SizedBox(height: 10),
                         Text('Ordinateur',style: TextStyle(color: Color.fromARGB(255, 0, 0, 0),fontSize: 20,fontWeight: FontWeight.bold),),
                         SizedBox(height: 40),
                          OnOffSwitch(),
