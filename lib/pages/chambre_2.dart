...
class Chambre2 extends StatefulWidget {
  const Chambre2({super.key});

  @override
  State<Chambre2> createState() => _Chambre2State();
}

class _Chambre2State extends State<Chambre2> {
  int? _selectedIndex ;
  @override
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                         ...
                         SizedBox(height: 20),
                         Text('Baffle',style: TextStyle(color: Color.fromARGB(255, 0, 0, 0),fontSize: 20,fontWeight: FontWeight.bold),),
                         SizedBox(height: 30),
                          OnOffSwitch(),
